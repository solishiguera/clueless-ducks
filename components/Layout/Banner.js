...
import wizelinkLogo from "/public/images/wizelink.png"
...
function Banner({ sessionData }) {
    ...
    <div className='flex flex-col'>
        <div className='flex flex-row bg-white'>
            ...
            <div className="w-[4rem] sm:w-[4.5rem] lg:w-[5rem] border-solid border-t-wizeline-red border-r-wizeline-red border-[32px] sm:border-[36px] lg:border-[40px] border-l-transparent border-b-transparent" />

            <div className='flex flex-row justify-between h-[4rem] sm:h-[4.5rem] lg:h-[5rem] grow bg-wizeline-red text-white'>
                ...
                <div className='flex flex-row self-center mr-3 sm:mr-6 lg:mr-10'>
                    {sessionData ? (
                        ...
                        <Link href="/api/auth/signin">
                            <div className="flex items-center space-x-2 p-3 mb-1 hover:bg-red-600 font-light rounded-xl cursor-pointer">
