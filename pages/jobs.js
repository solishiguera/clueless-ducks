            ...
            <div className="w-1/3 text-gray-900">
                  ...
                  <div className="px-2 mx-2 py-3">
                    <details className="group mb-4 rounded-md bg-white border-b-2 border-gray-500">
                      <summary className="relative flex cursor-pointer flex-wrap items-center rounded group-open:z-[1] group-open:rounded-b-none">
                        <h3 className="flex flex-1 p-4 pr-0 text-sm sm:text-base md:text-lg lg:text-xl font-thin">My applications</h3>
              ...
              <div className="bg-white rounded-xl shadow-md">
                ...
                <div className="px-2 mx-2 mt-0">
                  <details className="group mb-4 rounded-md bg-white border-b-2 border-gray-500">
                    <summary className="relative flex cursor-pointer flex-wrap items-center rounded group-open:z-[1] group-open:rounded-b-none">
                      <h3 className="flex flex-1 p-4 pr-0 text-sm sm:text-base md:text-lg lg:text-xl font-thin">Contract</h3>
                      <div className="flex w-auto items-center justify-center">
                        <div className="ml-2 origin-left transition-transform group-open:rotate-90 mt-2 mr-3 text-gray-900 text-sm sm:text-base md:text-lg lg:text-xl"><BsFillCaretRightFill/></div>
                      </div>
                    </summary>
                    <div className="flex flex-wrap p-1 m-1 mt-0 text-sm">
                      {
                        contracts.map((contract) =>
                          <span
                            ...
                            className="cursor-pointer font-semibold mb-2 px-3 mr-2 bg-green-100 text-green-600 rounded-md text-sm hover:bg-green-200">
                            {(contract == "PART_TIME") ? "Part Time" : "Full Time"}
                ...
                <div className="px-2 mx-2 mt-0">
                  <details className="group mb-4 rounded-md bg-white border-b-2 border-gray-500">
                    <summary className="relative flex cursor-pointer flex-wrap items-center rounded group-open:z-[1] group-open:rounded-b-none">
                      <h3 className="flex flex-1 p-4 pr-0 text-sm sm:text-base md:text-lg lg:text-xl font-thin">Location</h3>
                      <div className="flex w-auto items-center justify-center">
                        <div className="ml-2 origin-left transition-transform group-open:rotate-90 mt-2 mr-3 text-gray-900 text-sm sm:text-base md:text-lg lg:text-xl"><BsFillCaretRightFill/></div>
                      </div>
                    </summary>
                    <div className="flex flex-wrap p-1 m-1 mt-0 text-sm">
                      {
                        locations.map((location) =>
                          <span
                            ...
                            className="cursor-pointer font-semibold mb-2 px-3 mr-2 bg-blue-100 text-blue-600 rounded-md text-sm hover:bg-blue-200">
                            {location}
